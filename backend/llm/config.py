...
class LLMConfig(BaseSettings):
    ...
    Only supports custom REST API endpoint for local model deployment.
    ...
    enable_fallback: bool = Field(
        default=True,
        description="Enable fallback to hardcoded rules on LLM failure"
    )
...
def get_llm_config() -> LLMConfig:
    ...
    if _llm_config is None:
        ...
        yaml_paths = [
            Path(__file__).parent.parent / "cli" / "llm_config.yaml",  # CLI config (priority)
            ...
            try:
                ...
                with open(yaml_path, 'r', encoding='utf-8') as f:
                    ...
                    if yaml_config:
                        ...
                        yaml_mappings = [
                            ('endpoint', 'endpoint', 'https://llm-gateway.dev.cn-vwa.volkswagen-cea.com'),
        ...
        logger.info(f"LLM Config loaded: endpoint={_llm_config.endpoint}, "
